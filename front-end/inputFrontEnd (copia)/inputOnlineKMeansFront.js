...
// -------------------------------------------------------------------
    ...
    var InputModel = {}; // Declare empty global object
        ...
        InputModel.wsMsn        = { topic : "inputModel", message : "" };
...
/*    // Zoom
        ...
        function zoomed() {
            inputChart.select(".inputX.axis").call(inputXAxis);
            inputChart.select(".inputY.axis").call(inputYAxis);
        }
    ...
    function updateVisualization(){
        ...
        gaussGroupsEnter
            .append("circle")
            .attr("cx", function(d) { return inputXScale( d.mean[0] ); } )
            .attr("cy", function(d) { return inputYScale( d.mean[1] ); } )
            .attr("r", function(d) {  return inputXScale( 3*d.cov[0][0] ) - inputXScale( 0 ); })
            .attr("class", "3sig")
            .attr("fill", "yellow")
            .attr("opacity",0.5 )
        ...
        gaussGroupsEnter
            ...
            .attr("cx", function(d) { return inputXScale( d.mean[0] ); } )
            .attr("cy", function(d) { return inputYScale( d.mean[1] ); } )
            .attr("r", function(d) {  return inputXScale( 2*d.cov[0][0] ) - inputXScale( 0 ); })
            .attr("class", "2sig")
            .attr("fill", "orange")
            .attr("opacity",0.75 )
            .on("click", function(d){ selectGaussVis(d.id); d3.event.stopPropagation(); } );
        ...
        gaussGroupsEnter
            ...
            .attr("cx", function(d) { return inputXScale( d.mean[0] ); })
            .attr("cy", function(d) { return inputYScale( d.mean[1] ); })
            .attr("r", function(d) { return inputXScale( d.cov[0][0] ) - inputXScale( 0 ); } )
            .attr("class", "1sig")
            .attr("fill", "red")
            .attr("opacity",0.90 )
            .on("click", function(d){ selectGaussVis(d.id); d3.event.stopPropagation(); } );
